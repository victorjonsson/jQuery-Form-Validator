...
(function($, window) {
  ...
  $(window).bind('validatorsLoaded', function() {
    ...
    $.formUtils.LANG = {
      ...
      multiSelectRangeStart: 'Por favor, escolha entre ',
      multiSelectTooFewStart: 'Por favor, escolha pelo menos ',
      multiSelectTooManyStart: 'Por favor, escolhe no máximo ',
      multiSelectEnd: ' opção(ões)',
